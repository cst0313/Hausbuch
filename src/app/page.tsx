...
function FormatComparison() {
  const rows: Array<{
    ...
    },
    {
      ...
      hausbuch: "≈ 50 ms",
      delta: "~8× faster",
      note: "weighted by cache-hit rate. Both formats render in ~450 ms cold; plain prose just rarely hits cache.",
    },
    {
      ...
      hausbuch: "~90%",
      delta: "9×",
      note: "fixed section order + padded keys + volatile-at-bottom layout keeps the prefix bytes identical between renders.",
    },
    {
