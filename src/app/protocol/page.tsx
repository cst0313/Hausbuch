    ...
    <>
      <div className="relative z-10">
        ...
        <section className="max-w-3xl mx-auto px-6 pt-20 pb-16">
          ...
          >
            Lumen is a reference implementation of an open format — a living, bitemporal,
...
trailer        = "<!-- Lumen · " counts " · last write " timestamp " -->"`}
          </pre>
        </section>
...
<!-- Lumen · 41 facts · 7 sources · 2 conflicts · last write 2026-04-22T17:30Z -->`}
          </pre>
        </section>
        ...
        <section className="max-w-3xl mx-auto px-6 py-12">
          ...
          >
            ...
            <li>
              Where types matter, Lumen emits a parallel{" "}
              <code className="text-[13px] font-mono" style={{ color: "var(--amber-bright)" }}>
                Context.d.ts
              </code>
